...
$(function(){
	...
	function searchAppointment() {
		...
		$("#tt").datagrid('load', {
			"appointment.customerName" : $("#customerName").val(),
	...
	//打开新增试乘试驾预约窗口
	function openAppointmentAddDialog() {
		$("input[type=reset]").trigger("click");
		$("#dlg").dialog("open").dialog("setTitle", "添加试乘试驾预约信息");
		url = "../../AppointmentAction!addAppointment";
	}
	//打开修改试乘试驾预约窗口
...
<div id="body" data-options="region:'center'"> 
  ...
  <!-- 表格顶部工具按钮 -->
    <div id="tb">
        <a href="javascript:openAppointmentAddDialog()" id="ddd" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-add'">新增预约</a> 
